...
?>
	...
	<tr><td>
		Libro: 
		<input class="entrada" type="text" name="libro" maxlength="4" size="4" value="<?php echo $datos['libro'];?>">
		
		Acta: 
		<input class="entrada" type='text' name='partidan' maxlength='4' size='4' value="<?php echo $datos['partida'];?>">
		<input class="entrada" type='text' name='partidaab' maxlength='1' size='1'  value="<?php echo $datos['partidaab'];?>">
</td>
	</tr>

	<tr><td>
		Ministro:<input class="entradatx" type="text" name="ministro" maxlength="50" size="50" value="<?php echo $datos['ministro'];?>"></td>
	</tr>
	<tr><td>

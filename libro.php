<?php 
 ...
 <?php 
	...
	$base='bautismo';
	$sql="SELECT partidan,partidaab,fechasacr,nombre,paterno,materno FROM $base WHERE libro='$libro' AND librobis='$librobis' ORDER BY partidan ASC";
	...
	while ($consulta= mysqli_fetch_array($result))
{
  ...
  echo "<td  style='width: 50px;'>".$consulta['partidan']."-".$consulta['partidaab']."</td> <td  style='width:360px;'>".$consulta['nombre']." ".$consulta['paterno']." ".$consulta['materno'] ."</td><td style='width: 35px;'>".$consulta['fechasacr']."</td> ";
    }
